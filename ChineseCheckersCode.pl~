...
succ([ Ordi , Player ], Turno , PosList , IA ):-
	IA == 1 , Turno == 1 ,
	succCalc( Ordi , Ordi , Temp , Turno , IA ),
        distribucionJugadorV(Temp , Player , PosList ). %, writeln (PosList).

succ([ Ordi , _ ], Turno , PosList , IA ):-
	IA == 1 ,
        jugador == 2 ,
	succCalc( Ordi , Ordi , Temp , Turno , IA ),
	distribucionComputadoraR( Temp , Ordi , PosList ). %, writeln (PosList).
...
minimaxab( Posición , Turno , Profundidad , MejorMov , Valor , IA ):-
	succ( Posición , Turno , X , IA ),% Simulación del movimiento, X = lista de posiciones dispués de jugar
